  ...
  <div class="container py-5">
    <div class="row g-4 justify-content-center">
      ...
      <div class="col-lg-4 col-md-6">
        <a href="Reposos.php" class="text-decoration-none">
          <div class="card module-card border border-primary rounded-4 shadow-sm bg-light text-primary d-flex justify-content-center align-items-center">
            <div class="text-center">
              <i class="fas fa-bed-pulse fs-1 mb-3"></i>
              <h5 class="fw-semibold mb-0">Reposo</h5>
            </div>
          </div>
        </a>
      </div>
      ...
      <!-- Card: Licencias -->
      <div class="col-lg-4 col-md-6">
        <a href="Licencia.php" class="text-decoration-none">
          <div class="card module-card border border-primary rounded-4 shadow-sm bg-light text-primary d-flex justify-content-center align-items-center">
            <div class="text-center">
              <i class="fas fa-id-card fs-1 mb-3"></i>
              <h5 class="fw-semibold mb-0">Licencias</h5>
            </div>
          </div>
        </a>
      </div>
