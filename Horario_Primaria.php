...
$sql = "
  ...
  JOIN materias m ON m.id = h.materia_id AND m.nivel IN (2, 4, 6)
...
<div class="container my-5">
  <div class="card shadow-sm border-0 rounded-4">
    <div class="card-header bg-primary text-white rounded-top-4 d-flex align-items-center">
      ...
      <h5 class="mb-0">Gestión de Horario Primaria</h5>
    </div>
  ...
  <!-- Modal de edición -->
  <form method="POST" action="PHP/editar_horario_primaria.php" id="formEditarHorario">
    ...
    function editarHorario(id) {
      fetch('PHP/obtener_horario.php?id=' + id)
        ...
        .then(data => {
          ...
          fetch('PHP/obtener_materias_primaria.php')
            .then(res => res.json())
            .then(materias => {
