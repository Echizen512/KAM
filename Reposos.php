                ...
                echo "<tr>
                        ...
                        <td>
                          <div class='d-flex justify-content-center gap-3'>
                           ...
                           <a href='PDF/Reposos.php?id=" . $row['id_personal'] . "' class='download-link btn btn-outline-danger rounded-circle' data-id='" . $row['id_personal'] . "'> 
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        saveChangesButton.addEventListener('click', function () {
            ...
            window.location.href = `PDF/Reposos.php?id=${personaId}&fechaInicio=${fechaInicio}&fechaFin=${fechaFin}&motivo=${motivo}&condicionPermiso=${condicionPermiso}&nombreAutoridad=${nombreAutoridad}&cedulaAutoriza=${cedulaAutoriza}`;
            Swal.fire({
                icon: 'success',
                title: 'Éxito',
...
<script>
    ...
    Array.from(previewLinks).forEach(link => {
        link.addEventListener('click', (event) => {
            ...
            fetch(`./Preview/Reposo.php?id=${id}`)
