  ...
  <div class="container py-5">
    <div class="row g-4 justify-content-center">
      ...
      <div class="col-lg-4 col-md-6">
        <a href="Horario_Preescolar.php" class="text-decoration-none">
          <div class="card module-card border border-primary rounded-4 shadow-sm bg-light text-primary d-flex justify-content-center align-items-center">
            <div class="text-center">
              <i class="fas fa-child-reaching fs-1 mb-3"></i>
              <h5 class="fw-semibold mb-0">Preescolar</h5>
            </div>
          </div>
        </a>
      </div>
      ...
      <!-- Card: Primaria -->
      <div class="col-lg-4 col-md-6">
        <a href="Horario_Primaria.php" class="text-decoration-none">
          <div class="card module-card border border-primary rounded-4 shadow-sm bg-light text-primary d-flex justify-content-center align-items-center">
            <div class="text-center">
              <i class="fas fa-book-open-reader fs-1 mb-3"></i>
              <h5 class="fw-semibold mb-0">Primaria</h5>
            </div>
          </div>
        </a>
      </div>
      ...
      <!-- Card: Media General -->
      <div class="col-lg-4 col-md-6">
        <a href="Horario_Media.php" class="text-decoration-none">
          <div class="card module-card border border-primary rounded-4 shadow-sm bg-light text-primary d-flex justify-content-center align-items-center">
            <div class="text-center">
              <i class="fas fa-graduation-cap fs-1 mb-3"></i>
              <h5 class="fw-semibold mb-0">Media General</h5>
            </div>
          </div>
        </a>
      </div>
